...
def main():
    try:
        ...
        * Open the channel with a timeout
        ...
        file_path = os.path.join('C:','Users','Jacob Bennedsen','Desktop','Python Files','Learning','Creep_Test.csv')
        csvfile = open(file_path, 'w')
        filewriter = csv.writer(csvfile, delimiter=',', lineterminator='\n', quotechar='|', quoting=csv.QUOTE_MINIMAL)
        
        #Write header row to csv
        filewriter.writerow(['Time (s)','ch0 (V/V)','ch1 (V/V)','ch2 (V/V)','ch3 (V/V)','ch4 (V/V)','ch5 (V/V)','ch6 (V/V)','ch7 (V/V)','ch8 (V/V)','ch9 (V/V)'])
        ...
        for i in tms:
            ...
            filewriter.writerow([tms[i],v0,v1,v2,v3,v4,v5,v6,v7,v8,v9])
